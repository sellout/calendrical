{
  description = "Comprehensive date & time library";
        ...
        haskellDependencies = final: prev: hfinal: hprev:
          {
            ...
            ## Needed to bump the revision for GHC 9.12 support.
            fin = final.haskell.lib.overrideCabal hprev.fin {
              revision = "1";
              editedCabalFile = "sha256-W/88FVOmlEmdZdRqI+MMBkc+xkqyZs91X3/KOvEWkFQ=";
            };
          ...
          ## To work around haskell/cabal#9375.
          // (
            if final.lib.versionOlder hprev.ghc.version "9.8.3"
            then {
              Cabal = hfinal.Cabal_3_10_3_0;
              Cabal-syntax = hfinal.Cabal-syntax_3_10_3_0;
              ## This package really wants to use Cabal 3.10.2.0, so just re-
              ## pull it from Hackage.
              extensions =
